...
$vmSettings = "<div class='containers'>";
...
foreach ($vms as $vm) {
  ...
  $vmSettings .= "<div class='container_item'>";
  $vmSettings .= "<div class='info'><span><img class='docker_img' src='" . $img . "'></span>";

  $vmSettings .= "<span><strong>$vm</strong><br>Desc: $desc";

  $vmSettings .= "</span></div>";

  $vmSettings .= "<div class='settingC-box'><input class='settingC' type='checkbox' name='$vm'></div>";
    ...
    <dl style="padding-left: 12px;">
      ...
      <div>
        ...
        <blockquote class="inline_help">
          <p>You can click the folder icon for a menu of icons from the VMs currently inside the folder</p>
        </blockquote>
      </div>
      ...
      <div class="advanced" style="display: none">
        <dl>
          <dt>Start expanded on VM page:</dt>
          <dd><input class="basic-switch setting" name="docker_start_expanded" type="checkbox" /></dd>
        </dl>
        <blockquote class="inline_help">
            <p>Will make the folder start expanded on the VM page</p>
        </blockquote>
      </div>
      ...
      <div class="advanced" style="display: none">
        ...
        <blockquote class="inline_help">
            <p>Will make the folder start expanded on the dashboard</p>
        </blockquote>
      </div>
      ...
      <div class="advanced" style="display: none">
        ...
        <blockquote class="inline_help">
            <p><i class="fa fa-play green-text"></i> The green play icon will show when all VMs inside the folder that are set to <strong>autostart</strong> are running</p>
        </blockquote>
      </div>
