  ...
  <dl>
    ...
    <dd>
      <select name="Type" onchange="toggleMode(this,false);">
        ...
        <option value="Action">VM Action</option>
        <option value="Bash">Bash</option>
        <option value="Sub_Menu">VM Sub Menu</option>
      </select>
    </dd>
    <div id="popup-name">
      <dt id="dt1">Name:</dt>
    ...
    <div id="popup-action">
      ...
      <dd>
        <select name="action">
          ...
          <option value="pmsuspend">Hibernate</option>
          <option value="destroy">Force Stop</option>
          <option value="pause">Pause</option>
          <option value="pmwakeup">Resume</option>
        </select>
      </dd>
    </div>
...
<script>
    ...
    switch ($(el)[0].selectedIndex) {
        ...
        case 2: // Action
            ...
            var iconArray = ['play', 'stop', 'refresh', 'bed', 'bomb', 'pause', 'pause']
